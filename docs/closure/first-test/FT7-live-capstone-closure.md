...
|------|------|----------------------------------------|
| FT7-P1-01 marker taxonomy and denominator | ✅ closed | `working tree @ 4e4ca3b` + `tests/unit/test_pytest_markers.py` + `2026-06-13 08:53 UTC` |
| FT7-P1-02 FT1-FT6 required test gate | ✅ closed | `working tree @ 4e4ca3b` + `tests/integration/test_first_test_capstone.py::test_first_test_capstone_requires_ft1_ft6_closures` + `2026-06-13 08:53 UTC` |
| FT7-P2-01 evidence exporter | ✅ closed | `working tree @ 4e4ca3b` + `tests/unit/test_first_test_evidence_validator.py::test_evidence_exporter_writes_required_files` + `2026-06-13 08:53 UTC` |
| FT7-P2-02 evidence validator | ✅ closed | `working tree @ 4e4ca3b` + `tests/unit/test_first_test_evidence_validator.py` + `2026-06-13 08:53 UTC` |
| FT7-P3-01 API capstone live chain | ⏸ pending | `working tree @ 4e4ca3b` + `tests/integration/test_first_test_capstone.py -m live -q -rs` -> `1 skipped: RUN_FIRST_TEST_CAPSTONE=1 is required...` + `2026-06-13 08:53 UTC` |
| FT7-P3-02 capstone trace/evidence indexing | ✅ closed | `working tree @ 4e4ca3b` + `/mnt/usb/workspace/myvoiceresearch/test-runs/first-test-capstone-skipped-20260613T0850Z/manifest.json` + `2026-06-13 08:53 UTC` |
